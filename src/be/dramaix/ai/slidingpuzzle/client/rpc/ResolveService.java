...
public interface ResolveService extends RemoteService {

	PuzzleSolution resolve(State start, State goal, AlgorithmType algorithmType, HeuristicType heuristicType);
}